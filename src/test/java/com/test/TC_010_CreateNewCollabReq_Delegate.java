...
public class TC_010_CreateNewCollabReq_Delegate extends BaseClass{
	...
	public void createTcCollabReq() throws InterruptedException
	{
		...
		delegate.clickTxtBoxCifNumber("610");
		delegate.clickBtnEnter();
		delegate.clickBtnRequestForCollab();
		//delegate.clickBtnRequest();
	}
}
